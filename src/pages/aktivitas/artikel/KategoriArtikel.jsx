...
const KategoriArtikel = () => {
  ...
  const pageTitle = kategoriName
    ? `Kategori ${kategoriName} - Blog Perpustakaan Medayu Agung Surabaya`
    : "Kategori Blog - Blog Perpustakaan Medayu Agung Surabaya";
  const pageDescription = kategoriName
    ? `Baca blog dalam kategori ${kategoriName} dari Perpustakaan Medayu Agung Surabaya. Koleksi blog tentang sejarah, budaya, dan informasi perpustakaan.`
    : "Baca blog berdasarkan kategori dari Perpustakaan Medayu Agung Surabaya. Koleksi blog tentang sejarah, budaya, dan informasi perpustakaan.";
  const ogImage =
  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="keywords"
          content={`${kategoriName || "blog"}, perpustakaan medayu agung, blog perpustakaan surabaya, blog kategori, blog sejarah, blog budaya`}
        />
        ...
        <div className="blog-container">
          ...
          {!loading && !error && (
            <>
              {articles.length === 0 ? (
                <div className="blog-state">
                  <p>Belum ada Blog dalam kategori ini.</p>
                </div>
              ) : (
